...
// sockudoPublisher — gửi events tới Sockudo (Pusher-compatible HTTP API).
...
func newSockudoPublisher(cfg config.LiveConfig) *sockudoPublisher {
...
func (p *sockudoPublisher) publish(channel, event string, data any) error {
